...
include_once "/var/task/user/api" . "/ActionTypes.php";
include_once "/var/task/user/api" . "/Requests/Request.php";
include_once "/var/task/user/api" . "/Requests/CreateUser.php";
include_once "/var/task/user/api" . "/Requests/GetAuth.php";
include_once "/var/task/user/api" . "/Requests/AddPosition.php";
include_once "/var/task/user/api" . "/Requests/UpdatePosition.php";
include_once "/var/task/user/api" . "/Requests/DeletePosition.php";
include_once "/var/task/user/api" . "/Requests/GetCategories.php";
include_once "/var/task/user/api" . "/Requests/GetProducts.php";
include_once "/var/task/user/api" . "/Requests/GetCart.php";
include_once "/var/task/user/api" . "/Requests/SendInvoice.php";
include_once "/var/task/user/api" . "/Requests/GetShortCart.php";
include_once "/var/task/user/api" . "/Requests/CompleteCheckout.php";
include_once "/var/task/user/api" . "/Requests/Logout.php";

include_once "/var/task/user/api" . "/Sender.php";

include_once "/var/task/user/api" . "/Mail/Mail.php";
...
class Router
{
    ...
    {
        return (new \Actions\Handler(self::GetInstance()))->ToJson();
    }
}
